...
The Zephyr scripts are thin wrappers around a shared internal `ts-lib-zephyr-nodejs` library. Test results report per-story screenshots embedded directly into each Zephyr step.
