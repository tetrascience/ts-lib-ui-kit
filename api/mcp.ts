...
import catalogData from "./_components.json";
...
// The catalog is generated by `scripts/mcp/build-metadata.ts` and written next to
// this function as `_components.json`. Importing it lets Vercel's bundler inline
// the data directly into the function — so there is no outbound request (no SSRF
// surface) and no `vercel.json`/`includeFiles` needed to ship the data.
