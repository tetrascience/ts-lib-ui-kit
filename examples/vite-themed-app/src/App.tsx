...
import {
  ...
  Card,
  Modal,
} from "@tetrascience/tetrascience-react-ui";
    ...
    <ThemeProvider theme={customTheme}>
      <div style={{ padding: "40px", maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ padding: "20px 0" }}>
            ...
            >
              <p style={{ fontSize: "14px", color: "#92400E", margin: 0 }}>
                💡 <strong>Theme Applied:</strong> All components use the custom
                orange theme!
              </p>
            </div>
          </div>
        ...
        >
          ...
          >
            Built with <strong>TetraScience UI Kit</strong> • Custom Orange
            Theme
          </p>
