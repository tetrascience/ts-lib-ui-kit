...
export const TypeErrorWithErrorStack: Story = {
  name: "Type Error With Error Stack",
  parameters: {
    // Auto-generated by sync-storybook-zephyr - do not add manually
    zephyr: { testCaseId: "SW-T788" },
  },
  args: {
    error: (() => {
      try {
...
export const AxiosError500WithStringData: Story = {
  name: "Axios Error500 With String Data",
  parameters: {
    // Auto-generated by sync-storybook-zephyr - do not add manually
    zephyr: { testCaseId: "SW-T790" },
  },
  args: {
    error: createMockAxiosError(
      500,
...
export const AxiosError400WithObjectData: Story = {
  name: "Axios Error400 With Object Data",
  parameters: {
    // Auto-generated by sync-storybook-zephyr - do not add manually
    zephyr: { testCaseId: "SW-T791" },
  },
  args: {
    error: createMockAxiosError(
      400,
