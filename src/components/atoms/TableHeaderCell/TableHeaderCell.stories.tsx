...
export const MixedHeadersWithDropdowns: Story = {
  name: "Mixed Headers With Dropdowns",
  parameters: {
    // Auto-generated by sync-storybook-zephyr - do not add manually
    zephyr: { testCaseId: "SW-T851" },
  },
