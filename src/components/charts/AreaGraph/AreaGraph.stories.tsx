...
export const SmallSizeLegendRegression: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "Regression for SW-2157: at a small size (310×200) with a bottom legend and `xTickText`, the legend must not overlap the x-axis tick labels. `automargin` on the axes reserves the space.",
      },
    },
  },
  args: {
