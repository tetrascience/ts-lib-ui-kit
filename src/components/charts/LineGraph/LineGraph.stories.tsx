...
export const SmallSizeLegendRegression: Story = {
  name: "Small Size — Legend vs Ticks (SW-2157)",
  parameters: {
    // Auto-generated by sync-storybook-zephyr - do not add manually
    ...
    docs: {
      description: {
        story:
          "Regression for SW-2157: at a small size with a bottom legend and `xTickText`, the legend must not overlap the x-axis tick labels (`automargin` reserves the space).",
      },
    },
  },
  args: {
