...
export const AutoRangeLinePlot: Story = {
  name: "Auto Range Line Plot",
  args: {
    width: 1000,
    height: 600,
  ...
  parameters: {
    ...
    docs: {
      description: {
        story:
          "This story demonstrates how the LinePlot automatically calculates appropriate ranges when none are provided.",
      },
    },
  },
};
...
export const WideRangeAutoScaled: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "A graph with a wider data range, demonstrating how the LinePlot adapts its scales automatically.",
      },
    },
  },
};
...
export const NarrowRangeAutoScaled: Story = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        story: "A graph with a narrower data range, showing how the LinePlot adapts to focused data.",
      },
    },
  },
};
...
export const LinePlotStartingFromZero: Story = {
  name: "Line Plot Starting From Zero",
  args: {
    width: 1000,
    height: 600,
    dataSeries: generateDataStartingFromZero(),
...
export const NoTitle: Story = {
  ...
  play: async ({ canvasElement, step }) => {
    ...
    await step("No title block is rendered", async () => {
      ...
      expect(canvas.queryByText("Line Plot")).not.toBeInTheDocument();
    });
