...
const meta: Meta<typeof StackedChromatogram> = {
  title: "Data Viz/Chromatogram/Stacked",
  component: StackedChromatogram,
  parameters: {
    layout: "centered",
  },
  tags: ["autodocs"],
...
export default meta;
type Story = StoryObj<typeof StackedChromatogram>;
